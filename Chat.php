	...
	<!--------------------------------------------------------Preloader----------------------------------------------------------->
		...
		<i class="fa fa-bars toggle_menu"></i>
			...
			<div class="sidebar_menu">
				...
				<i class="fa fa-times"></i>
					...
					<iframe class="sidebar_menu"
						width="500"
						height="768"
						src="https://console.dialogflow.com/api-client/demo/embedded/82a6e147-63a7-4ea6-9421-4a6ae7275c48">
					</iframe>
	  ...
	  <!-- Video Section -->
			...
			<div class="user-heading" >
						...
						<b><h1>HAVE QUESTIONS?</h1></b>
					
			</div>
			
			<div class="user-heading1" >
					
						<i><h1>ASK OUR CHATBOT</h1></i>
